        ...
        <div className="flex w-full flex-col bg-black/40 p-4 sm:w-64 sm:shrink-0 sm:overflow-y-auto sm:rounded-r-sm sm:p-5">
          ...
          {editing ? (
            <textarea
              ...
              className="mt-3 w-full resize-none rounded-sm bg-white/5 px-2 py-2 font-hand text-2xl leading-tight text-white outline-none placeholder:text-white/40"
            />
          ) : (
            <p
              role={authed ? "button" : undefined}
              onClick={() => authed && setEditing(true)}
              className={`mt-3 whitespace-pre-wrap font-hand text-2xl leading-tight ${
